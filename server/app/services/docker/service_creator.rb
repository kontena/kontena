...
module Docker
  class ServiceCreator
    ...
    def build_env(instance_number)
      ...
      env << "KONTENA_SERVICE_NAME=#{grid_service.name_with_stack(ignore_default_stack: true, stack_separator: '/')}"
    ...
    def build_labels
      ...
      if grid_service.linked_to_load_balancer?
        ...
        labels['io.kontena.load_balancer.name'] = lb.name_with_stack(ignore_default_stack: true, stack_separator: '/')
