...
Kontena::Cli::GEMSPEC = Gem::Specification.new do |spec|
  ...
  spec.add_runtime_dependency "excon", ">= 0.49.0", "< 0.50"
  spec.add_runtime_dependency "tty-prompt", "~> 0.10"
  spec.add_runtime_dependency "clamp", ">= 1.1", "< 1.2"
  spec.add_runtime_dependency "ruby_dig", "< 0.1"
  spec.add_runtime_dependency "launchy", ">= 2.4.3", "< 2.5"
  spec.add_runtime_dependency "hash_validator", ">= 0.7", "< 0.8"
  spec.add_runtime_dependency "retriable", ">= 2.1", "< 2.2"
  spec.add_runtime_dependency "opto", "1.8.3"
  spec.add_runtime_dependency "semantic", "~> 1.5"
  spec.add_runtime_dependency "safe_yaml", "~> 1.0"
  spec.add_runtime_dependency "liquid", ">= 4.0", "< 4.1"
end
