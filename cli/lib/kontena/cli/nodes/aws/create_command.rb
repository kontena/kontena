module Kontena::Cli::Nodes::Aws
  class CreateCommand < Clamp::Command
    ...
    option "--region", "REGION", "Region", default: 'eu-west-1'
    option "--key-pair", "SSH_KEY_PAIR", "AWS SSH key pair", required: true
    option "--type", "SIZE", "Instance type", default: 't2.small'
    option "--storage", "STORAGE", "Storage size (GB)", default: '30'
