  ...
  describe '#deploy' do
    ...
    context 'when api url and token are valid' do
      before(:each) do
        ...
        allow(subject).to receive(:create_service).and_return({'id' => 'kontena-test-mysql', 'name' => 'kontena-test-mysql'},{'id' => 'kontena-test-wordpress', 'name' => 'kontena-test-wordpress'})
